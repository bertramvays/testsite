...
class News(models.Model):
    ...
    category = models.ForeignKey('Category', on_delete=models.PROTECT, verbose_name='Категория')  #  related_name='get_news' я переназначения news_set в ОРМ
...
class Category(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('category', kwargs={"category_id": self.pk})  # 1-й параметр название маршрута
